...
ГРУППА 003 (Угол опережения зажигания):
- 003-4 (УОЗ): На холостом ходу (700–900 об/мин) норма 4–8 °ПКВ. При разгоне (2000+ об/мин) УОЗ должен плавно расти в диапазон 15–35 °ПКВ (в зависимости от нагрузки). Резкие провалы (<5 °ПКВ) или чрезмерно высокие значения (>40 °ПКВ) указывают на детонацию, неверную прошивку или проблемы с датчиком детонации.
