...
# Совместимость со старыми вызовами (на всякий случай)
def save_history_to_disk(history, vin_code):
    save_chat_history(history)

def load_history_from_disk():
    return load_chat_history(), st.session_state.get("vin_code", "")
...
# --- ЧАТ-ВВОД (с автоматическим извлечением VIN) ---
if user_input := st.chat_input("Напишите симптомы или задайте вопрос..."):
    if not API_KEY:
        ...
        # Автоматически выхватываем VIN из сообщения
